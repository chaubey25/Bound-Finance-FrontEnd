  ...
  return (
    ...
    <MakerDaoContext.Provider value={{ maxBCK }}>
      <div className="w-full max-w-[1449px] mx-auto px-6">
        <div className="flex flex-col items-center justify-center gap-6 mt-10">
          ...
          <div className="mt-7 flex flex-row items-center justify-center gap-10 flex-wrap">
            <div className="text-center mt-4">
              <p className="font-mont text-15 text-skyblue">Caution: BCK Draw Limit (Risk of Liquidation Near Max)</p>
              <p className="text-gray-300 font-bold font-Helvetica text-8"> (Caution: Minting the limit risks liquidation.)</p>
            ...
            <div className="text-center mt-4">
              ...
              <p className="text-gray-300 font-bold font-Helvetica text-2xl">13%</p>
            ...
            <div className="text-center mt-4">
              ...
              <p className="text-gray-300 font-bold font-Helvetica text-2xl">150%</p>
            ...
            <div className="text-center mt-4">
              <p className="font-mont text-15 text-skyblue">Collateral Amount BCKETH</p>
              <p className="text-gray-300 font-bold font-Helvetica text-2xl">{collateralAmount ? `${collateralAmount}  BCKETH` : 'No collateral'}</p>
            </div>
            <div className="text-center mt-4">
        ...
        <div className="mt-10 gap-10 flex flex-col items-center lg:flex-row sm:mt-40">

{/* This is the container for MintContent and the Link */}
<div className="flex flex-col">
  <MintContent />
  
  <div className="flex justify-center items-center w-full mt-8 mb-20"> {/* Added mb-20 for extra margin at the bottom */}
    <Link to="/staking" className="BoxGradient-buttons drop-shadow-xl hover:text-white py-2 px-4 rounded">
        Press To Start Step 3. (BCK Savings Account)
    </Link>
</div>

</div>

<div className="mt-10 md:mt-4 w-full max-w-[630px] mx-auto">
  <MintTabs />
</div>
</div>
</div>
